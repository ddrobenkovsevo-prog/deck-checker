...
class IdleScreen(QWidget):
    ...
    def _build(self) -> None:
        ...
        # version
        ver = _label("v1.0", "label_info")
        ver.setStyleSheet(f"color: {COLORS['text_dim']};")
        header.addWidget(ver, 0, Qt.AlignmentFlag.AlignVCenter)
        ...
        instruction = _label(
            "Place shoe on conveyor\nand close the lid to begin",
            "label_subtitle",
        )
        ...
        btn_manual = QPushButton("MANUAL START")
